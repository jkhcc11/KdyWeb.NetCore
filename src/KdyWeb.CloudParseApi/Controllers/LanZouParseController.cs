...
namespace KdyWeb.CloudParseApi.Controllers
{
    ...
    /// </summary>
    [CustomRoute("lzyx")]
    public class LanZouParseController : BaseCloudDiskApiController
    {
        private readonly ISubAccountService _subAccountService;
        private readonly ILoginUserInfo _loginUserInfo;

        public LanZouParseController(ISubAccountService subAccountService, ILoginUserInfo loginUserInfo)
        {
        ...
        public async Task<KdyResult<IList<BaseCloudQueryFileDto>>> QueryAliFileListAsync([FromQuery] BaseCloudQueryFileInput input)
        {
            ...
            var parseService = new LanZouCloudParseService(new BaseConfigInput(subAccount.ShowName,
        ...
        public async Task<KdyResult> BatchUpdateNameAsync(BaseBatchUpdateNameInput input)
        {
            ...
            var parseService = new LanZouCloudParseService(new BaseConfigInput(subAccount.ShowName, subAccount.CookieInfo, subAccount.Id));
        ...
        public override async Task<KdyResult<string>> GetCurrentCookieTypeAsync()
        {
            ...
            var aliCookieType = allCookieType.FirstOrDefault(a => a.BusinessFlag == CloudParseCookieType.LanZouYouXiang);
