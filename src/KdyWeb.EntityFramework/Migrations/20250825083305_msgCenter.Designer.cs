...
namespace KdyWeb.EntityFramework.Migrations
{
    ...
    [Migration("20250825083305_msgCenter")]
    partial class msgCenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KdyWeb.Entity.BaseConfig.SysBaseConfig", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("KdyWeb.Entity.CloudParse.CloudParseUserChildren", b =>
                {
                    ...
                    b.Property<string>("RelationalUserIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("KdyWeb.Entity.KdyUserNew.KdyMenuNew", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("KdyBase_KdyMenu", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.KdyUserNew.KdyMsgCenter", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("KdyBase_KdyMsgCenter", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.KdyUserNew.KdyRoleMenuNew", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("KdyBase_KdyRoleMenu", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.KdyUserNew.KdyRoleNew", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("KdyBase_KdyRole", (string)null);
                });
            ...
            modelBuilder.Entity("KdyWeb.Entity.SequenceRecord.GiftUserConfig", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("GiftEndTime")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("GiftPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime>("GiftStartTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("GiftUseCount")
                        .HasColumnType("int");

                    b.Property<int>("GiftUserType")
                        .HasColumnType("int");

                    b.Property<int?>("GiftValidCount")
                        .HasColumnType("int");
                    ...
                    b.Property<long>("VenuesId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.ToTable("SequenceRecord_GiftUserConfig", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.SequenceRecord.SequenceUseRecord", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("UseRecordRemark")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("VenuesShortName")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.HasKey("Id");

                    b.ToTable("SequenceRecord_SequenceUseRecord", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.SequenceRecord.SequenceUserRecord", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SequenceRecord_SequenceUserRecord", (string)null);
                });

            modelBuilder.Entity("KdyWeb.Entity.SequenceRecord.VenuesConfig", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("VipFreeSteps")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("SequenceRecord_VenuesConfig", (string)null);
                });
            ...
            modelBuilder.Entity("KdyWeb.Entity.KdyUserNew.KdyRoleMenuNew", b =>
                {
                    b.HasOne("KdyWeb.Entity.KdyUserNew.KdyMenuNew", "KdyMenuNew")
                        .WithMany("KdyRoleMenuNews")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("KdyMenuNew");
                });
