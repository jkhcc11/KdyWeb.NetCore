...
namespace KdyWeb.EntityFramework.Migrations
{
    ...
    public partial class v160 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<string>(
                name: "TaskName",
                table: "KdyTask_VideoConvertTask",
                type: "nvarchar(50)",
                maxLength: 50,
                nullable: false,
                defaultValue: "",
            ...
            migrationBuilder.CreateTable(
                name: "CloudParse_ParseRecordHistory",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    SubAccountId = table.Column<long>(type: "bigint", nullable: false),
                    RecordHistoryType = table.Column<int>(type: "int", nullable: false),
                    FileIdOrFileName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CloudParse_ParseRecordHistory", x => x.Id);
                });
        }
