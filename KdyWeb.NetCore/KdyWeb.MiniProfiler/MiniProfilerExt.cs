...
namespace KdyWeb.BaseInterface.Extensions
{
    ...
    public static class MiniProfilerExt
    {
        ...
        /// 初始化MiniProfiler
        /// </summary>
        public static IServiceCollection AddMiniProfile(this IServiceCollection services)
        {
            //todo:https://miniprofiler.com/dotnet/AspDotNetCore
            services.AddMiniProfiler(options =>
            {
                // All of this is optional. You can simply call .AddMiniProfiler() for all defaults
                options.RouteBasePath = "/kdyProfile";
        ...
        /// 初始化MiniProfiler
        /// </summary>
        public static IApplicationBuilder UseMiniProfile(this IApplicationBuilder app)
        {
            app.UseMiniProfiler();
            return app;
        }
